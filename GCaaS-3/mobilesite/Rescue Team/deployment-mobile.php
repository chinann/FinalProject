...
<script>
    ...
    function staticHospital() {
        ...
        if (document.getElementById('hospital').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=All Hospital",true);
            xmlhttp.send();
        }
        else{
            for (var i = 0; i < markerHos.length; i++) {
    ...
    function staticSomeHospital() {
        ...
        if (document.getElementById('h1').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=Government Hospital",true);
            xmlhttp.send();
        }
        ...
        if (document.getElementById('h2').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=Private Hospital",true);
            xmlhttp.send();
        }
        ...
        if (document.getElementById('h3').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=Health Center",true);
            xmlhttp.send();
        }
    ...
    function staticSchool() {
        ...
        if (document.getElementById('school').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=All School",true);
            xmlhttp.send();
        }
        else{
            for (var i = 0; i < markerSch.length; i++) {
    ...
    function staticSomeSchool() {
        ...
        if (document.getElementById('s1').checked == true && document.getElementById('s2').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=Government and Private School",true);
            xmlhttp.send();
        }
        ...
        if (document.getElementById('s1').checked == true && document.getElementById('s3').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=Government School and University",true);
            xmlhttp.send();
        }
        ...
        if (document.getElementById('s2').checked == true && document.getElementById('s3').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=Private School and University",true);
            xmlhttp.send();
        }
        ...
        if (document.getElementById('s1').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=Government School",true);
            xmlhttp.send();
        }
        ...
        if (document.getElementById('s2').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=Private School",true);
            xmlhttp.send();
        }
        ...
        if (document.getElementById('s3').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=University",true);
            xmlhttp.send();
        }
    ...
    function staticPolice() {
        ...
        if (document.getElementById('police').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=All Police station",true);
            xmlhttp.send();
        }
        else{
            for (var i = 0; i < markerPol.length; i++) {
    ...
    function staticFire() {
        ...
        if (document.getElementById('fire').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=All Fire station",true);
            xmlhttp.send();
        }
        else{
            for (var i = 0; i < markerFir.length; i++) {
    ...
    function staticTemple() {
        ...
        if (document.getElementById('temple').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=All Temple",true);
            xmlhttp.send();
        }
        else{
            for (var i = 0; i < markerTem.length; i++) {
    ...
    function staticSomeTemple() {
        ...
        if (document.getElementById('t1').checked == true && document.getElementById('t2').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=Temple and Church",true);
            xmlhttp.send();
        }
        ...
        if (document.getElementById('t1').checked == true && document.getElementById('t3').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=Temple and Muslim",true);
            xmlhttp.send();
        }
        ...
        if (document.getElementById('t2').checked == true && document.getElementById('t3').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=Church and Muslim",true);
            xmlhttp.send();
        }
        ...
        if (document.getElementById('t2').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=Church",true);
            xmlhttp.send();
        }
        ...
        if (document.getElementById('t3').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/staticData.py?typeStatic=Muslim",true);
            xmlhttp.send();
        }
    ...
    function dynamicTwitter(){
        ...
        if (document.getElementById('twitter').checked == true) {
            ...
            xmlhttp.open("GET","http://localhost/cgi-bin/dynamicData.py?dbName=<?php echo $_SESSION['depname'] ?>",true);
            xmlhttp.send();
        }
        else{
            for (var i = 0; i < markerTW.length; i++) {
    ...
    function changeStatus(id) {
        ...
        xmlhttp.open("GET","http://localhost/cgi-bin/status.py?status="+status+"&id="+id+"&dbName=<?php echo $_SESSION['depname'] ?>",true);
        xmlhttp.send();
    }
    ...
    function saveRequest(lat,lng){
        ...
        xmlhttp.open("GET","http://localhost/cgi-bin/insertRequest.py?type="+type+"&msg="+msg+"&lat="+lat+"&lng="+lng+"&dbName=<?php echo $_SESSION['depname'] ?>",true);
        xmlhttp.send();
    }
    ...
    function searchByPolygon() {
        ...
        if (document.getElementById("hospital").checked == false && document.getElementById("school").checked == false && document.getElementById("police").checked == false && document.getElementById("fire").checked == false &&document.getElementById("temple").checked == false) {
            ...
            if (document.getElementById("hospital").checked == true) {
                ...
                xmlhttp.open("GET","http://localhost/cgi-bin/searchByArea.py?type="+type+"&polygon="+polygon,true);
                xmlhttp.send();
            }
        }
    }
        ...
        if (document.getElementById("Thai").checked == true) {
            Province = new google.maps.ImageMapType({
                getTileUrl: function (tile, zoom) {
                    return "http://localhost:8080/geoserver/gwc/service/tms/1.0.0/province%3Al050302_gistda_50k_sim_1km_resolve@EPSG%3A900913@png/"+zoom+"/"+tile.x+"/"+((Math.pow(2,zoom)-tile.y)-1)+".png";
                },
                maxZoom: 20,
                name: "Flood_Layer",
