...
<main class="container" role="main">
  <div class="panel panel-default">
    <div class="slider" style="font-size: 16px;">
      <ul class="my-menu">
        <li style="background-color: #f2f2f2;"><a href="#" class="disabled" ><?php echo $_SESSION['depname'];?><div style="font-size: 12px;">  (last access : <?php echo $deployment_LastAccess ?>)</div></a>
        <li><a href="#">Summary</a>
          <ul>
        ...
        <li><a href="#">Danamic Data Layer</a>
          <ul>
        ...
        <li><a href="#">Member</a>
          <ul>
            <li style="background-color: #f2f2f2;"><a class="disabled">
                Username
