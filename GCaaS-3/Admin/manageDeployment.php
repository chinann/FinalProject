...
<div id="body-content" style="padding: 20px 50px 0px 50px;margin-top: 80px;">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <b>Aere of Deployment : </b> <?php echo $deployment_Area ?> <br>
            <div id="map"></div>
        </div>
    </div>
</div><!--END header body-->
        ...
        <div id="member" class="panel-collapse collapse ">
            <div class="panel-body">
                ...
                <div style="text-align: left;padding: 0px 50px 0px 20px;">
                    <button type="button" class="btn btn-danger" onclick="deleteSelected()"><i class="fa fa-trash-o" aria-hidden="true"> </i>
                        Delete selected
                    </button>
                            ...
                            for ($i = 0; $i < $rows_count; $i++) {
                                for ($j = 0; $j < $column_count; $j++) {
                                    if ($j == 0) {
                                        ...
                                        ?>
                                        <tr>
                                        <td><input class="checkbox" type="checkbox" value="" id="input<?php echo $i?>" onclick="unCheckAll(this)"></td>
                                        ...
                                        <td><button class="btn-danger" onclick="deleteUser()"><i class="fa fa-trash-o" aria-hidden="true"></i></button></td>
                                        </tr>
                                        <?php
                                    }
                                }
...
<div style="text-align: center;margin: 20px 20px">
    <a href="deployment.php" type="button" class="btn btn-success" onclick="linkToDep()">Go to Website <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                      <tr>
                        <td><p class="col-sm-4" id="usern"></p></td>
                        <td><p class="col-sm-4" id="email"></p></td>
                        <td>
                          <select class="col-sm-4" id="role" style="margin-top:5px" hidden>
                            <option value="Admin">Admin</option>
                            <option value="Operator">Operator</option>
            ...
            <script>
                ...
                function addUser(){
                    if (document.getElementById("add-user").value != "") {
                        ...
                        xmlhttp.open("GET","http://" +"<?php echo $_SESSION['host'] ?>" +"/GCaaS-3/Python/addUser.py?user="+username+"&role="+role+"&depname=<?php echo $_SESSION['depname']?>",true);
                        xmlhttp.send();
                    }
                    else {
                        alert("Insert Username or E-mail");
                ...
                function deleteUser(){
                    if(confirm("Do you to delete this User?") == true){
                        ...
                        xmlhttp.open("GET","http://" +"<?php echo $_SESSION['host'] ?>" +"/GCaaS-3/Python/deleteRow.py?deployName=<?php echo $_SESSION['depname']?>&user=<?php echo $_SESSION['username'] ?>",true);
                        xmlhttp.send();
                    }
                }
