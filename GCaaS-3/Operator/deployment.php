                        ...
                        <div class="input-group">
                            <?php
                                ...
                                if (! $_SESSION['connection']) {
                                    ...
                                    $result_Hashtag = pg_exec($_SESSION['connection'], "SELECT \"deployment_Hashtag\" FROM table_deployment WHERE \"deployment_Name\" = '" .$_SESSION["depname"]."';");
...
<script>
    ...
    var rows_deploy;
    var result_staticID_array = [];
    var result_staticDataLayer_Name_array = [];
    ...
    function searchByPolygon() {
        ...
        if (document.getElementById("hospital").checked == false && document.getElementById("school").checked == false && document.getElementById("police").checked == false && document.getElementById("fire").checked == false && document.getElementById("temple").checked == false && document.getElementById("twitter").checked == false) {
            ...
            if (document.getElementById("twitter").checked == true) {
                ...
                xmlhttp.open("GET","http://" +"<?php echo $_SESSION['host'] ?>" +"/GCaaS-3/Python/searchByArea.py?type="+type+"&polygon="+polygon+"&dbName=<?php echo $_SESSION['depname'] ?>",true);
                xmlhttp.send();
            }
        }
    }
